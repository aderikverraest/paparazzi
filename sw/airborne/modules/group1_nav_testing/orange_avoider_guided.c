...
// define settings
float oag_color_count_frac = 0.4f;       // obstacle detection threshold as a fraction of total of image
float oag_floor_count_frac = 0.01f;       // floor detection threshold as a fraction of total of image
float oag_color_count_turning_frac = 0.15f;
